...
from DiffLib.diffsinger_midi.fs2 import FastSpeech2MIDI
from DiffLib.encoder import ParameterEncoder
...
class GaussianDiffusion(nn.Module):
    def __init__(self, phone_encoder, out_dims, denoise_fn,
        ...
        if hparams.get('use_midi') is not None and hparams['use_midi']:
            ...
            self.fs2 = ParameterEncoder(phone_encoder,hparams)
    ...
    def forward(self, txt_tokens, mel2ph=None, spk_embed=None,
        ...
        if not infer:
            ...
            if hparams.get('pndm_speedup') and hparams['pndm_speedup'] > 1:
                ...
                from DiffLib.dpm_solver_pytorch import NoiseScheduleVP, model_wrapper, DPM_Solver
